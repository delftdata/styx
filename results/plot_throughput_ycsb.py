...
# plt.text(start_migration_time - 3, 4250, f'{start_migration_time}s', color='red', fontsize=20, ha='center', va='top')
# plt.axvline(x=end_migration_time, color='green', linestyle='--', label='End Migration', linewidth=3)
# plt.text(end_migration_time + 3, 4250, f'{end_migration_time}s', color='green', fontsize=20, ha='center', va='top')
plt.xlabel("Time (s)")
...
plt.xlim([0, 120])
plt.tight_layout()
plt.savefig("throughput_ycsb.pdf")
plt.show()

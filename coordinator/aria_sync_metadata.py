class AriaSyncMetadata(object):
    ...
    def set_aria_processing_done(self, workers_logic_aborts: set[int]) -> bool:
        self.sync_sum += 1
        self.logic_aborts_everywhere |= workers_logic_aborts
        return self.check_sum()

    def set_aria_commit_done(self, aborted: set[int], remote_t_counter: int, processed_seq_size: int) -> bool:
        self.sync_sum += 1
    ...
    def set_empty_sync_done(self):
        self.sync_sum += 1
        return self.check_sum()

    def set_deterministic_reordering_done(self, remote_read_reservation, remote_write_set, remote_read_set):
        self.sync_sum += 1

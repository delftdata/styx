...
class Pool:
    ...
    async def send_sequential(self, messages: list[bytes]):
        """
    ...
    async def send_batched(self, messages: list[bytes]):
        """
